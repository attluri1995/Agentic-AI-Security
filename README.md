# Damn Vulnerable AI Agents (DVAA)

A hands-on learning lab for agentic AI security — inspired by [DVWA](https://github.com/digininja/DVWA), focused on vulnerabilities documented in the [MITRE ATLAS](https://atlas.mitre.org/) framework.
...
| 24 | `multi_agent_delegation_hijack/` | Multi-agent orchestrator / delegation abuse *(DVAA extension)* | Related: [AML.T0053](https://atlas.mitre.org/techniques/AML.T0053), [AML.T0080.001](https://atlas.mitre.org/techniques/AML.T0080.001) | Planned |
...
See [indirect_prompt_injection/README.md](indirect_prompt_injection/README.md), [direct_prompt_injection/README.md](direct_prompt_injection/README.md), and [triggered_prompt_injection/README.md](triggered_prompt_injection/README.md) for complete walkthroughs.
